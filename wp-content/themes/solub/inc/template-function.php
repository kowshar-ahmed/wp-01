...
?>
    ...
    <?php if ($social_x): ?>
        <a href="<?php echo esc_url($social_x); ?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
...
{
    $social_foo_fb = get_theme_mod('social_foo_fb', __('#', 'solub'));
    $social_foo_x = get_theme_mod('social_foo_x', __('#', 'solub'));
    $social_foo_in = get_theme_mod('social_foo_in', __('#', 'solub'));
    $social_foo_pin = get_theme_mod('social_foo_pin', __('#', 'solub'));
    $social_foo_ln = get_theme_mod('social_foo_ln', __('#', 'solub'));

?>
    <?php if ($social_foo_fb): ?>
        <a href="<?php echo esc_url($social_foo_fb); ?>"><i class="fa-brands fa-facebook"></i></a>
    <?php endif; ?>


    <?php if ($social_foo_in): ?>
        <a href="<?php echo esc_url($social_foo_in); ?>"><i class="fa-brands fa-instagram"></i></a>
    <?php endif; ?>

    <?php if ($social_foo_ln): ?>
        <a href="<?php echo esc_url($social_foo_ln); ?>"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13" viewBox="0 0 13 13" fill="currentColor">
    ...
    <?php if ($social_foo_x): ?>
        <a href="<?php echo esc_url($social_foo_x); ?>"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="15px" height="15px">
                <path d="M 4.4042969 3 C 3.7572969 3 3.3780469 3.7287656 3.7480469 4.2597656 L 9.7363281 12.818359 L 3.7246094 19.845703 C 3.3356094 20.299703 3.6578594 21 4.2558594 21 L 4.9199219 21 C 5.2129219 21 5.4916406 20.871437 5.6816406 20.648438 L 10.919922 14.511719 L 14.863281 20.146484 C 15.238281 20.680484 15.849953 21 16.501953 21 L 19.835938 21 C 20.482937 21 20.862187 20.272188 20.492188 19.742188 L 14.173828 10.699219 L 19.900391 3.9902344 C 20.232391 3.6002344 19.955359 3 19.443359 3 L 18.597656 3 C 18.305656 3 18.027891 3.1276094 17.837891 3.3496094 L 12.996094 9.0097656 L 9.3945312 3.8554688 C 9.0205313 3.3194687 8.4098594 3 7.7558594 3 L 4.4042969 3 z" fill="currentcolor"></path>
            </svg></a>
    <?php endif; ?>
    <?php
}
