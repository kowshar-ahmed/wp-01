...
add_action( 'tgmpa_register', 'solub_register_required_plugins' );

function solub_register_required_plugins() {
    /*
    ...
    $plugins = [
        ...
        [
            'name'         => esc_html__( 'Solub Core', 'exdos' ),
            'slug'         => 'solub-core',
            'source'       => $url . 'solub-core.zip',
            'required'     => true,
            'external_url' => $url . 'solub-core.zip',
        ],
        [
