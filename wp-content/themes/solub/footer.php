      <!-- footer area start -->
      <footer class="tp-footer-ptb p-relative pt-80" data-bg-color="#1F2220">
          <div class="container">
                      ...
                      <div class="col-xl-4 col-lg-3 col-md-6 col-12">
                          <div class="tp-footer-widget tp-footer-col-1 mb-50">
                              <div class="tp-footer-logo mb-35">
                                  <a href="index.html"> <img data-width="120" src="assets/img/logo/logo-rgb.png"
                                          alt=""></a>
                              </div>
                          ...
                          <div class="tp-footer-widget tp-footer-col-4 mb-50">
                              <div class="tp-footer-widget-content">
                                  <div class="tp-footer-widget-contact">
                                      ...
                                      <div class="tp-footer-widget-contact">
                                          <a href="tel:555-0111"><span><svg xmlns="http://www.w3.org/2000/svg"
                                          ...
                                          <a href="mailto:solubmain@info.com"><span><svg
                                                      ...
                                                      <path d="M5.7998 7.80054H12.1998" stroke="#FF7029"
                                                          stroke-width="1.5" stroke-linecap="round" />
                                                      <path d="M5.7998 10.6006H10.1998" stroke="#FF7029"
                                                          stroke-width="1.5" stroke-linecap="round" />
                                                  </svg></span>solubmain@info.com</a>
                                          <a href="https://www.google.com/maps" target="_blank"><span><svg
                  ...
                  <div class="row align-items-center">
                      ...
                      <div class="col-lg-6">
                          <div class="tp-footer-widget-social text-lg-end">
                              ...
                              <a href="#"><svg xmlns="http://www.w3.org/2000/svg" width="13" height="13"
