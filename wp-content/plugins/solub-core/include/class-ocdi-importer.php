...
function tp_ocdi_import_files() {
    ...
    return array(
      array(
        'import_file_name'           => 'Home Version 01',
        'local_import_file'             => trailingslashit( get_template_directory() ) .'sample-data/content.xml',
        'local_import_widget_file' => trailingslashit( get_template_directory() ) . 'sample-data/widget.wie',
        'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'sample-data/customizer.dat',
        'import_preview_image_url' => plugins_url( 'assets/img/home-1.jpg', dirname(__FILE__) ),
        'preview_url'                => 'https://inayai.com/venturestore//',
      ),
      array(
        'import_file_name'           => 'Home Version 02',
        'local_import_file'             => trailingslashit( get_template_directory() ) .'sample-data/content.xml',
        'local_import_widget_file' => trailingslashit( get_template_directory() ) . 'sample-data/widget.wie',
        'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'sample-data/customizer.dat',
        'import_preview_image_url' => plugins_url( 'assets/img/home-2.jpg', dirname(__FILE__) ),
        'preview_url'                => 'https://inayai.com/venturestore//home-02',
      ),
    );
}
...
function tp_ocdi_after_import_setup( $demo ) {
    $front_page_id = "";
    $blog_page_id = "";
    if( "Home Version 01" == $demo['import_file_name'] ){
        // Assign front page and posts page (blog page).
        $front_page_id = tp_ocdi_page( 'Home' );
        $blog_page_id  = tp_ocdi_page( 'Blog' );
    }
    elseif( "Home Version 02" == $demo['import_file_name'] ){
        // Assign front page and posts page (blog page).
