 ...
 * @since 1.0.0
 */
class Solub_Blog_Post extends Widget_Base
{
	...
	{
		return __('Solub Blog Post', 'solub-core');
	}
...
$widgets_manager->register(new Solub_Blog_Post());
