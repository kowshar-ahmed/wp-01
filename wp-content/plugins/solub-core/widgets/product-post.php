 ...
 * @since 1.0.0
 */
class Solub_Product_Post extends Widget_Base
{
	...
	{
		return __('Product Post', 'solub-core');
	}
	...
	protected function register_controls_section()
	{
		$this->start_controls_section(
			'post_section',
			[
				'label' => __('Product Post', 'solub-core'),
			]
		);
	...
	protected function render()
	{
		...
		// WP_Query arguments
		$args = array(
			'post_type'              => 'product', // use any for any kind of post type, custom post type slug for custom post type
...
$widgets_manager->register(new Solub_Product_Post());
