...
class Inline_Editing extends Widget_Base
{
	...
	{
		return __('Inline Editing', 'solub-core');
	}
	...
	protected function register_controls()
	{
		...
		$this->add_control(
			'description',
			[
				'label' => __('Description', 'solub-core'),
				'type' => Controls_Manager::TEXTAREA,
				'default' => __('Description', 'solub-core'),
			]
		);
